...
|----|-------------|----------|---------|--------|-------------|
|BUG-1 |Hint incorrectly applies scoring when player has zero score  |Major |R-01 |New |https://github.com/PLP-Database-Design/wk-5-JayWaithera101-1/issues/2 |
|BUG-2|Game repeats a very small set of words reducing gameplay randomness|Medium|R-02|New|https://github.com/PLP-Database-Design/wk-5-JayWaithera101-1/issues/3 |
|BUG-3|Game has no win condition and never ends|Major|R-03|New|https://github.com/PLP-Database-Design/wk-5-JayWaithera101-1/issues/4 |
